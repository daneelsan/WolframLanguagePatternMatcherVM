...
// 	return 0;
// }
EXTERN_C DLLEXPORT int initialize()
{
	wlr_err_t err0 = WLR_SDK_START_RUNTIME(WLR_DYNAMIC_LIBRARY, WLR_SIGNED_CODE_MODE, "/Applications/Wolfram.app/Contents", NULL);
	if (err0 != WLR_SUCCESS)
	{
...
EXTERN_C DLLEXPORT void uninitialize()
{
	wlr_ReleaseAll();
	return;
}
